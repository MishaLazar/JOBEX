...
import { SkillFilterPipe } from 'src/app/filters/skillsFilter';


@NgModule({
    declarations: [ListCardItemComponent,PersonalDataComponent,EngagementsComponent,SkillsComponent,WishListComponent,SkillFilterPipe],
